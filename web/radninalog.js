...
const updateRadniNalog = async () => {
    ...
    const radni_nalog = {
        ...
        datum_i_vrijeme_izdavanja: document.getElementById("datum_i_vrijeme_izdavanjaUpdate").value,
        rok_zavrsavanja: document.getElementById("rok_zavrsavanjaUpdate").value,
